...
class ShortageProducts extends React.Component {
                ...
                if (response.ok) {
                    response.json().then(json_response => {
                        ...
                        this.setState({
                            ...
                            main_data: {},
                            message:"All the Products have enough quantity",
                            isLoaded: true,
                            error: null
                        });
                    }
                        ...
                        this.setState({
                            products_data: json_response,
                            main_data: {},
                            message:"We need to place an Order for following products!!",
                            isLoaded: true,
                            error: null
                        });
    ...
    render() {
        ...
        {
            h2.push(<h2><i className="far fa-grin-alt" aria-hidden="true"></i><i className="far fa-grin-alt" aria-hidden="true"></i>{this.state.message}<i className="far fa-grin-alt" aria-hidden="true"></i><i className="far fa-grin-alt" aria-hidden="true"></i></h2>);
        }
        else{
